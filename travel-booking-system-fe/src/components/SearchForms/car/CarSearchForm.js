        ...
        <div>
            ...
            <div className="searchFormRow">
                <div className="searchFormItem">
                    ...
                    <input className="input" type={"date"} onChange={(e) => setPickUp(e.target.value)}/>
                    {pickUp === null && <label className="requiredLabel">*You must select pick-up date</label>}

                </div>

                <div className="searchFormItem">
                    <label className="myLabelStyle">Drop-off date</label>
                    <input required={true} className="input" type={"date"} onChange={(e) => setDropOff(e.target.value)}/>
                    {dropOff === null && <label className="requiredLabel">*You must select pick-up date</label>}
                </div>
